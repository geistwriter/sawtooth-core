...
class WrappedNodeController(NodeController):
    def __init__(self, controller, data_dir=None, manage_data_dir=None):
        self._controller = controller
        self._manage_data_dir = manage_data_dir
        self._data_dir = data_dir
        if self._data_dir is None:
            self._data_dir = tempfile.mkdtemp()
            self._manage_data_dir = True
    ...
    def clean(self):
        if self._manage_data_dir is True:
